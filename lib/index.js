...
var DEFAULT_MAX_ENTITY_EXPANSIONS = 1e4;
var Config = import_koishi.Schema.intersect([
  import_koishi.Schema.object({
    ...
    maxEntityExpansions: import_koishi.Schema.natural().min(100).max(1e5).default(DEFAULT_MAX_ENTITY_EXPANSIONS).description("单个 Feed 允许处理的最大 XML 实体数量，用于限制异常内容的资源消耗。")
  }).description("请求设置"),
  import_koishi.Schema.object({
...
function parseFeed(xml, feedUrl, maxSummaryLength = 500, maxEntityExpansions = DEFAULT_MAX_ENTITY_EXPANSIONS) {
